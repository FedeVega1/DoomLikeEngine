...
//	{
//		std::array<int, DEFAULT_BUFFER_WIDTH> surfacePoints;
//		DrawWall(sector.sectorWalls[i], sector.surface, surfacePoints);
//	}
//}
//
//void D2Renderer::DrawWall(const ProcessedWall& wall, SectorSurface surface, std::array<int, DEFAULT_BUFFER_WIDTH>& points)
//{
